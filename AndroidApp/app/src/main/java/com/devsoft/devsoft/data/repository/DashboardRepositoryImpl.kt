...
class DashboardRepositoryImpl(
    ...
    override suspend fun getDeliveryOrders(): List<com.devsoft.devsoft.domain.model.DeliveryOrder> {
        return try {
            supabase.postgrest["delivery_orders"].select().decodeList<com.devsoft.devsoft.domain.model.DeliveryOrder>()
        } catch (e: Exception) {
            emptyList()
        }
    }
