-- ===============================================================================
-- FIX: Prevent Triple Credit Multiplication & Recalculate Accurate Balances
-- ===============================================================================

-- 1. Redefine process_sale function so that customer credit is ONLY updated once 
--    via the credit_transactions table trigger (trigger_update_customer_credit).
...
BEGIN
    ...
    -- NOTE: Inserting into credit_transactions automatically triggers trigger_update_customer_credit ONCE.
...
-- 2. Correct the inflated customer credit balances in Supabase
UPDATE customers 
SET current_credit = 13065.00 
WHERE name ILIKE '%Cafeteria Universitaire%';
